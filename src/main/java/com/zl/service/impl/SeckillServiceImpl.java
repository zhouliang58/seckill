...
import com.zl.dao.SuccessSeckilledDao;
import com.zl.dao.cache.RedisDao;
...
import com.zl.exception.SeckillException;
import com.zl.service.SeckillService;
...
public class SeckillServiceImpl implements SeckillService
{
    ...
    private final String salt="zhouliang";
    ...
    public Exposer exportSeckillUrl(long seckillId) {
        ...
        logger.info("redis seckill:{}",seckill);
        if (seckill == null) {
            //2:访问数据库
